  ...
  const packagesData = [
    {
      title: "Sunset Cruise",
      slug: "sunset-cruise",
      shortDescription: "A private golden-hour cruise available Monday, Tuesday, Saturday, and Sunday from 6:00 PM to 8:30 PM.",
      fullDescription: "A private golden-hour cruise designed for couples, families, and small groups who want a relaxed sunset experience on the lake. Available Monday, Tuesday, Saturday, and Sunday from 6:00 PM to 8:30 PM.",
      ...
      sortOrder: 0,
      includedItems: JSON.stringify(["Private sunset cruise", "Captain included", "Comfortable pontoon seating", "Golden-hour lake views", "BYOB welcome", "Snacks and coolers welcome"]),
      highlights: JSON.stringify(["$100 per person", "Monday, Tuesday, Saturday, and Sunday", "6:00 PM - 8:30 PM"]),
    ...
    },
    {
      ...
      slug: "fishing-trip",
      shortDescription: "A four-hour fishing-ready pontoon trip with Sunday and Monday morning or afternoon windows.",
      fullDescription: "A relaxed fishing-ready pontoon experience for friends, small groups, and lake lovers. Available Sunday 8:00 AM - 12:00 PM, Sunday 1:00 PM - 5:00 PM, Monday 8:00 AM - 12:00 PM, and Monday 1:00 PM - 5:00 PM.",
      duration: "4 hours",
      capacity: "Up to 6 passengers",
      startingPrice: "$400+",
      ...
      highlights: JSON.stringify(["$400 and up", "Sunday 8-12 or 1-5", "Monday 8-12 or 1-5"]),
    ...
    },
    {
      ...
      fullDescription: "A private event cruise for birthdays, bridal groups, celebrations, and special moments. Available Sunday 8:00 AM - 12:00 PM, Sunday 1:00 PM - 5:00 PM, and Monday 1:00 PM - 5:00 PM.",
      duration: "4 hours",
      capacity: "Up to 6 passengers",
      startingPrice: "$425",
      priceLabel: "Sun/Mon windows",
      ...
      highlights: JSON.stringify(["$425 flat package", "Sunday 8-12 or 1-5", "Monday 1-5"]),
    ...
    },
    {
      ...
      fullDescription: "A private lake celebration perfect for bachelorette parties, birthdays, bridal groups, and special moments. This legacy package is kept inactive so admins can reactivate it if needed.",
      duration: "4 hours",
      capacity: "Up to 6 passengers",
      ...
      showOnExperiencesPage: false,
      imageUrl: "/images/bachelorette-cruise.png",
      icon: "sparkles",
      ctaLabel: "Book Bachelorette Cruise",
      sortOrder: 30,
      includedItems: JSON.stringify(["Private pontoon experience", "Captain included", "Photo-friendly lake views", "BYOB welcome"]),
      highlights: JSON.stringify(["Photo-worthy views", "Celebration vibes"]),
      optionalAddOns: JSON.stringify(["Decorations", "Extended time", "Custom playlist"]),
    },
    {
